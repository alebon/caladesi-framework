...
Modify your build.sbt
    ...
    libraryDependencies += "net.caladesiframework" % "caladesi-web_2.9.1" % "0.3.0-SNAPSHOT" % "compile"
...
dependencies {
    // Caladesi Framework
    compile "net.caladesiframework:caladesi-web_$scalaVersion:0.3.0-SNAPSHOT"
}
```
